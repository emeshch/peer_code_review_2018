#Создать словарь, в котором ключами являются предложения, а в качестве значения выступает словарь с ключами-словами
#и значениями-длинами слов (например, {"Мама вымыла раму": {"Мама": 4, "вымыла": 6, "раму": 4}, ...}).
