#   Вам нужно написать программу, которая загадывает слова.В задании обязательно использовать словарь.
...
# ФАЙЛ со словами называется так же как и эта программа, только расширение другое
