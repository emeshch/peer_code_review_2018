...
# 4. сколько в тексте форм на -ed, а также сколько из них образованы от глаголов на -y  или -e (например, studied, lied).
# Омонимией типа red можно не заморачиваться. (сорри, я люблю заморачиваться)
# файл для словаря называется так же, только расширение другое
